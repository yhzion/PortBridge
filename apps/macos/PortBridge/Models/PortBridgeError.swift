...
nonisolated enum PortBridgeError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .serverUnreachable(let host, _):
            return String(localized: "error.serverUnreachable", defaultValue: "\(host) 서버에 연결할 수 없습니다.")
        case .remoteToolsMissing:
        ...
        case .forwardingDiedEarly(let stderr):
            return String(localized: "error.forwardingDiedEarly", defaultValue: "포워딩이 즉시 종료되었습니다: \(stderr)")
        }
    }
}
